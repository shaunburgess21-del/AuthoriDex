...
const TOP_100_PEOPLE = [
  ...
  { name: "Selena Gomez", category: "Entertainment", displayOrder: 30, bio: "Singer, actress, and producer known for pop hits and cultural impact." },
  ...
  { name: "Rihanna", category: "Entertainment", displayOrder: 33, bio: "Grammy-winning artist, businesswoman, and cultural icon with global influence." },
  { name: "Beyoncé", category: "Entertainment", displayOrder: 34, bio: "Legendary performer, songwriting powerhouse, and cultural trendsetter." },
  { name: "Taylor Swift", category: "Entertainment", displayOrder: 35, bio: "Multiplatinum artist known for songwriting, career reinvention, and global impact." },
  { name: "Ariana Grande", category: "Entertainment", displayOrder: 36, bio: "Pop sensation known for vocal talent, chart success, and devoted fanbase." },
  { name: "Justin Timberlake", category: "Entertainment", displayOrder: 37, bio: "Singer, dancer, and actor known for music career and entertainment success." },
  { name: "Cardi B", category: "Entertainment", displayOrder: 38, bio: "Grammy-winning rapper known for boldness, hits, and cultural commentary." },
  { name: "Nicki Minaj", category: "Entertainment", displayOrder: 39, bio: "Rap icon known for unique style, lyrical skills, and industry influence." },
  { name: "Chris Brown", category: "Entertainment", displayOrder: 40, bio: "Versatile artist known for dancing, singing, and music production." },
  { name: "Ed Sheeran", category: "Entertainment", displayOrder: 41, bio: "Singer-songwriter known for acoustic hits and record-breaking chart performance." },
  ...
  { name: "Charli XCX", category: "Entertainment", displayOrder: 46, bio: "Electronic music artist known for innovative sound and cultural influence." },
  { name: "PinkPantheress", category: "Entertainment", displayOrder: 47, bio: "Emerging music artist known for genre-blending sounds and creative expression." },
