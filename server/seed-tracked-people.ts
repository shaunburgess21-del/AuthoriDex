...
const TOP_100_PEOPLE = [
  ...
  { name: "Tim Cook", category: "Tech", displayOrder: 18, bio: "CEO of Apple, driving innovation in consumer technology and sustainable business practices." },
  ...
  { name: "Narendra Modi", category: "Politics", displayOrder: 61 },
  { name: "Xi Jinping", category: "Politics", displayOrder: 62 },
  { name: "Vladimir Putin", category: "Politics", displayOrder: 63 },
  { name: "Claudia Sheinbaum", category: "Politics", displayOrder: 64 },
  { name: "Mark Carney", category: "Politics", displayOrder: 65 },
  { name: "Bernie Sanders", category: "Politics", displayOrder: 66 },
  { name: "Emmanuel Macron", category: "Politics", displayOrder: 67 },
  { name: "Keir Starmer", category: "Politics", displayOrder: 68 },
  { name: "Mike Johnson", category: "Politics", displayOrder: 69 },
  { name: "Hakeem Jeffries", category: "Politics", displayOrder: 70 },
  { name: "Sarah McBride", category: "Politics", displayOrder: 71 },
  { name: "Andy Kim", category: "Politics", displayOrder: 72 },
  { name: "Prabowo Subianto", category: "Politics", displayOrder: 73 },
  { name: "Cyril Ramaphosa", category: "Politics", displayOrder: 74 },

  // Athletes (20)
  { name: "LeBron James", category: "Sports", displayOrder: 75 },
  { name: "Stephen Curry", category: "Sports", displayOrder: 76 },
  { name: "Kylian Mbappé", category: "Sports", displayOrder: 77 },
  { name: "Neymar", category: "Sports", displayOrder: 78 },
  { name: "Giannis Antetokounmpo", category: "Sports", displayOrder: 79 },
  { name: "Anthony Edwards", category: "Sports", displayOrder: 80 },
  { name: "Jayson Tatum", category: "Sports", displayOrder: 81 },
  { name: "Victor Wembanyama", category: "Sports", displayOrder: 82 },
  { name: "Jalen Hurts", category: "Sports", displayOrder: 83 },
  { name: "Dak Prescott", category: "Sports", displayOrder: 84 },
  { name: "Saquon Barkley", category: "Sports", displayOrder: 85 },
  { name: "Shohei Ohtani", category: "Sports", displayOrder: 86 },
  { name: "Juan Soto", category: "Sports", displayOrder: 87 },
  { name: "Kevin Durant", category: "Sports", displayOrder: 88 },
  { name: "Karim Benzema", category: "Sports", displayOrder: 89 },
  { name: "Sachin Tendulkar", category: "Sports", displayOrder: 90 },
  { name: "Tyson Fury", category: "Sports", displayOrder: 91 },
  { name: "Serena Williams", category: "Sports", displayOrder: 92 },
  { name: "Simone Biles", category: "Sports", displayOrder: 93 },
  { name: "Naomi Osaka", category: "Sports", displayOrder: 94 },
  
  // Additional Notable Figures
  { name: "Roger Federer", category: "Sports", displayOrder: 95 },
  { name: "Rafael Nadal", category: "Sports", displayOrder: 96 },
  { name: "Lewis Hamilton", category: "Sports", displayOrder: 97 },
  { name: "Usain Bolt", category: "Sports", displayOrder: 98 },
  { name: "Michael Phelps", category: "Sports", displayOrder: 99 },
  { name: "Tiger Woods", category: "Sports", displayOrder: 100 },
];
