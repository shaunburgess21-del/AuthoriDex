...
async function seedXpActions() {
  ...
  const actions = [
    ...
    { actionKey: 'prediction_win', displayName: 'Prediction Win', xpValue: 50, dailyCap: null, description: 'Bonus XP when a prediction settles in your favour (once per market)' },
