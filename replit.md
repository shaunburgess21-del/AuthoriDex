...
- **Scoring Engine**:
    ...
    - **Canary People List**: 10 well-known people across categories (Trump, Musk, LeBron, Bad Bunny, Ronaldo, Modi, Zuckerberg, Kendrick, Putin, AOC) act as early-warning canaries. If 4+ canaries fail simultaneously, accelerates source health state transition to DEGRADED. Results surfaced in health summary.
