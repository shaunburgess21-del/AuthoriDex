...
- **OpenAI**: `gpt-5.4` (default via `AI_DEFAULT_MODEL`) for AI-generated summaries, About bios, and other AI features. Per-scope overrides available via `PROFILE_ABOUT_MODEL`, `WHY_TRENDING_MODEL`, `AGENT_RATIONALE_MODEL`, `MARKET_RESOLVER_MODEL`, `WORLD_MARKETS_MODEL`, `AI_DRAFT_MODEL`.
