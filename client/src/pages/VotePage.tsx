    ...
    return (
      <div className="flex items-center gap-2" data-testid={`${testIdPrefix}-option-row-${index}`}>
        ...
        <div className="flex items-center gap-2 flex-1 p-2 rounded-lg border bg-muted/30 min-w-0">
          ...
          <Button type="button" variant="ghost" size="icon" onClick={handleClearSelection} className="shrink-0 h-7 w-7" data-testid={`${testIdPrefix}-option-clear-${index}`}>
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative flex-1">
          ...
          <Input
            ...
            onFocus={() => { if (searchQuery.length > 0 || (value.name && !value.personId)) setShowDropdown(true); }}
              ...
              >
                ...
                {filteredCelebrities.map((celebrity) => (
                  ...
                  >
                    ...
                    <Badge variant="outline" className="ml-auto text-[10px] bg-cyan-500/15 dark:bg-cyan-500/10 text-cyan-500 dark:text-cyan-300 border-cyan-500/40 dark:border-cyan-400/30">
                      Auto
                    </Badge>
                  </button>
                ))}
