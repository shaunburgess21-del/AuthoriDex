...
function CurateProfileCardProfile({ 
  ...
  return (
    ...
    >
      <Card 
        className="hub-card-hover lb-row-neutral p-4 relative"
...
function FeaturedPollCard({
  ...
  return (
    <div className="relative h-full">
      <Card
        className={`hub-card-hover lb-row-neutral relative pt-6 px-5 pb-5 ${voted ? "max-md:pb-3" : ""} bg-card/80 backdrop-blur-sm h-full min-h-[390px] md:min-h-[300px] flex flex-col shadow-none md:shadow-sm rounded-[12px] md:rounded-xl`}
