...
import { Download, Link2, Megaphone, Palette, Share2 } from "lucide-react";
...
export type BrandingSubTab = "assets" | "tokens" | "og" | "banner" | "social";

const TAB_ORDER: BrandingSubTab[] = ["assets", "tokens", "og", "banner", "social"];
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Logo downloads, design reference, link previews, site banner, and social PNGs
        </p>
      </div>
