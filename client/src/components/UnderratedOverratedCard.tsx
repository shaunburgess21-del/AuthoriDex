...
export function UnderratedOverratedCard({ 
  ...
  return (
    ...
    <Card 
      className="relative pt-6 px-5 pb-5 transition-all duration-200 bg-card/80 backdrop-blur-sm h-full min-h-[380px] md:min-h-0 flex flex-col border-0 md:border md:border-slate-700/50 shadow-none md:shadow-sm group-hover:shadow-lg md:group-hover:shadow-cyan-500/20 rounded-none md:rounded-xl"
