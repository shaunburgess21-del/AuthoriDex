...
const DropdownMenuRadioItem = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.RadioItem> & {
    /** "dot" = default radio circle; "none" = bold/muted text only (filter/sort menus). */
    indicator?: "dot" | "none"
  }
>(({ className, children, indicator = "dot", ...props }, ref) => (
  <DropdownMenuPrimitive.RadioItem
    ...
    className={cn(
      ...
      indicator === "dot" && "pl-8 pr-2",
      indicator === "none" &&
        "gap-2 px-3 whitespace-nowrap text-muted-foreground hover:bg-accent hover:text-foreground data-[state=checked]:font-semibold data-[state=checked]:text-foreground",
      className
    )}
    {...props}
  >
