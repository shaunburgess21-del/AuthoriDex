...
export function BattleCard({ battle, compact = false }: BattleCardProps) {
  return (
    <div className={compact ? "" : "px-0 md:px-2"}>
      <Card 
        className="p-4 hover:translate-y-[-2px] hover:shadow-lg hover:border-purple-500/40 hover:shadow-purple-500/20 transition-all duration-200 relative z-0 hover:z-10 rounded-none md:rounded-xl min-h-[390px] md:min-h-0 border-0 md:border md:border-transparent shadow-none md:shadow-sm"
