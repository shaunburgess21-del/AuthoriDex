...
export const RULES_CONTENT: Record<string, RulesEntry> = {
  jackpot: {
    ...
    steps: [
      ...
      { icon: <Crown className="h-4 w-4 text-amber-500" />, title: "Ꝟ100 Per Entry", description: "Each prediction costs Ꝟ100. You can enter multiple times with different numbers to improve your chances." },
  ...
  updown: {
    ...
    description: "Each week, a fixed baseline score is captured at market open (Monday 00:00 UTC). Buy UP or DOWN shares — each winning share pays Ꝟ1 at close.",
    steps: [
      ...
      { icon: <Target className="h-4 w-4 text-violet-500" />, title: "Buy UP or DOWN Shares", description: "Each share you buy pays Ꝟ1 if your side wins. UP wins if the closing score finishes above the baseline; DOWN wins if it finishes below. Exact tie = full refund." },
      { icon: <Trophy className="h-4 w-4 text-violet-500" />, title: "Price = Crowd Probability", description: "Live share prices reflect the crowd's view in real time — a Ꝟ0.30 share implies a 30% chance. Cheaper shares pay more if your side wins. Sell anytime before close to lock in profits or cut losses." },
    ]
  },
  h2h: {
    title: "How Head-to-Head Works",
    description: "Buy shares of the person you think will finish the week with the higher Trend Score. Winning shares pay Ꝟ1 each at close.",
    steps: [
      ...
      { icon: <Trophy className="h-4 w-4 text-violet-500" />, title: "Ꝟ1 Per Winning Share", description: "Share prices move in real time. Each winning share pays Ꝟ1 at close, so cheaper shares pay bigger multiples — sell anytime before close to lock in profits or cut losses." },
    ]
  },
  gainer: {
    title: "How Category Races Work",
    description: "Buy shares of the candidate you think will be the biggest mover. Winning shares pay Ꝟ1 each at close.",
    steps: [
  ...
  community: {
    title: "World Markets",
    description: "These markets track verifiable global events (elections, business acquisitions, viral moments). Buy Yes or No shares — winners pay Ꝟ1 per share on resolution.",
    steps: [
      ...
      { icon: <Target className="h-4 w-4 text-violet-500" />, title: "Yes/No Shares", description: "Buy Yes shares if you think the event happens, No shares if you think it doesn't. Each winning share pays Ꝟ1 on resolution." },
      { icon: <Trophy className="h-4 w-4 text-violet-500" />, title: "Sell Anytime Before Close", description: "Share prices move as news breaks. Cheaper shares pay bigger multiples on a win — sell early to lock in a profit or cut losses, or hold to settlement for the full Ꝟ1 per winning share." },
    ]
  },
  predictions: {
    title: "Welcome to Predictions",
    description: "Trade shares on the world's most talked-about people. Vox is virtual — climb the prediction leaderboard and prove you know who the world is paying attention to.",
    steps: [
      ...
      { icon: <TrendingUp className="h-4 w-4 text-violet-500" />, title: "Up or Down", description: "Buy UP or DOWN shares on whether someone's Trend Score finishes above or below their weekly baseline. Winning shares pay Ꝟ1 at close." },
