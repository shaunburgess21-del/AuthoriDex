...
export function WorldMarketsTeaserRail({
  ...
  return (
    <section className="mb-10 px-1.5 md:px-0" data-testid="world-markets-teaser-rail">
      <div className="mb-3 border-t-[3px] border-t-emerald-500 rounded-t-lg bg-[linear-gradient(to_bottom,rgba(16,185,129,0.12)_0%,transparent_75%)] dark:bg-[linear-gradient(to_bottom,rgba(16,185,129,0.08)_0%,transparent_75%)]">
        <div className="flex items-center justify-between gap-2 px-3 py-3 md:px-5">
          <div className="flex items-center gap-3 min-w-0">
            <div className="h-10 w-10 rounded-lg bg-emerald-500/15 dark:bg-emerald-500/10 hidden sm:flex items-center justify-center shrink-0">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                {liveCount > 0 && (
                  <Badge
                    className="px-2 py-0.5 text-[11px] font-semibold bg-emerald-500/20 dark:bg-emerald-500/15 text-emerald-600 dark:text-emerald-400 border border-emerald-500/40 dark:border-emerald-400/30"
          ...
          <Button
            ...
            size="sm"
            onClick={onSeeAll}
            className="shrink-0 text-emerald-600 dark:text-emerald-400 hover:text-emerald-500 dark:hover:text-emerald-300 text-[14px]"
      ...
      <div className="text-center mt-2 md:mt-4">
        <Button
          ...
          size="sm"
          onClick={onSeeAll}
          className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-500 dark:hover:text-emerald-300 text-[14px]"
